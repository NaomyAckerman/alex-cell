                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between align-items-center">
                                    <label for="konter-gambar" class="img-preview rainbow">
                                        <i class="img-icon mdi mdi-camera"></i>
                                        <img src="" class="img d-none" alt="konter">
                                    </label>
                                    <div class="custom-file col-7">
                                        <input type="file" class="custom-file-input" name="konter_gambar" id="konter-gambar">
                                        <label for="konter-gambar" class="custom-file-label img-text" data-browse="Cari">Pilih gambar konter</label>
